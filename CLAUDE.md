...
- [`cmd/hamster`](cmd/hamster/) — the server binary. `hamster serve` is a dev preview: object data on disk, metadata in memory until the BadgerDB layer lands (a restart forgets buckets and keys).
