...
Extended by [ADR-0029](0029-ca-custody-and-issuance.md): CA custody and issuance — self-managed default, external PKI as a first-class option, and why the CA private key never enters the Raft log.
